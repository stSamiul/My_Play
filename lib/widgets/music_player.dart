    ...
    return Scaffold(
      appBar: AppBar(
        ...
        leading: IconButton(
            ...
            icon: Icon(Icons.arrow_back_ios_sharp, color: Colors.purple[200])),
          ...
          Container(
            ...
            child: Row(
              ...
              children: [
                GestureDetector(
                  child:
                      Icon(Icons.skip_previous, color: Colors.purple[200], size: 55),
                ...
                GestureDetector(
                  child: Icon(Icons.skip_next, color: Colors.purple[200], size: 55),
                  behavior: HitTestBehavior.translucent,
                  onTap: () {
